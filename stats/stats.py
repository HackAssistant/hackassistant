...
class ApplicationStats(base.BaseStats):
    ...
    country = base.ApplicationFormChart(base.Chart.BAR, order=4)
    ...
    university = base.ApplicationFormChart(base.Chart.BAR, order=7)
    degree = base.ApplicationFormChart(base.Chart.BAR, order=8)
